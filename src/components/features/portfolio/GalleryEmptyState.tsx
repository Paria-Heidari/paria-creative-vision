...
export default function GalleryEmptyState() {
  return (
    ...
    >
      <Stack direction="vertical" gap={{ base: 6, md: 8 }} align="center" justify="center">
        ...
        <Typography variant="paragraph" as="p" className="text-foreground-muted max-w-md text-center">
